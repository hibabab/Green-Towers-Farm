...
const ProductInfo = ({ productInfo }) => {
  ...
  const image = getImageUrl(productInfo.imageUrl);
  ...
  return (
     <div className="w-full h-full flex flex-row">
      ...
      <div className="w-full bg-white p-8 flex flex-col justify-between overflow-auto">
        ...
        <button
          ...
          className="w-full py-4 bg-primeColor hover:bg-black duration-300 text-white text-lg mt-6"
        >
          Add to Cart
        </button>
